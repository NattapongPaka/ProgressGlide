...
import com.frank.progressglide.progress.ProgressDataFetcher;
import com.frank.progressglide.progress.ProgressListener;
import com.frank.progressglide.progress.ProgressResponseBody;
...
//        frameLayout.addView(progressWheel, layoutParams);
        ...
        OkHttpClient okClient = mOkHttpClient.build();
